...
const getSecurityHeaders = (isDev: boolean) => {
  ...
  const cspHeader = {
    ...
    value: isDev
      ...
      : "default-src 'self'; connect-src 'self' http://api.compass.local:3030 ws://api.compass.local:3030 https://compass-api.karaoketest.ru:80 https://api.open-meteo.com https://api.exchangerate-api.com https://api-maps.yandex.ru https://geocode-maps.yandex.ru https://yastatic.net https://*.maps.yandex.net https://*.yandex.ru https://api.compasstransfer.kg; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api-maps.yandex.ru https://yastatic.net https://*.yandex.ru; style-src 'self' 'unsafe-inline' https://yastatic.net https://*.yandex.ru; img-src 'self' data: https: https://core-renderer-tiles.maps.yandex.net https://yastatic.net https://*.maps.yandex.net https://*.yandex.ru; media-src 'self' https://www.youtube.com https://youtube.com; frame-src https://www.youtube.com https://youtube.com;",
  };

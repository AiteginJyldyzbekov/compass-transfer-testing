...
export default function ShuttleOrderCreatePage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">Создание шаттл заказа</h1>
      </div>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              Форма создания шаттл заказа находится в разработке.
              <br />

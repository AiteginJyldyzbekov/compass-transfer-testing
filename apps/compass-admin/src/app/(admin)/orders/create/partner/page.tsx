...
export default function PartnerOrderCreatePage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">Создание партнерского заказа</h1>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Заказ от партнерской организации
              </p>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              Форма создания партнерского заказа находится в разработке.
              <br />

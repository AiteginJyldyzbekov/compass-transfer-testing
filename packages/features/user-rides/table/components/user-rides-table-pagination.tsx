...
interface UserRidesTablePaginationProps {
  paginatedRides: GetRideDTO[];
  totalCount: number;
  pageSize: number;
  hasNext: boolean;
  hasPrevious: boolean;
...
export function UserRidesTablePagination({
  paginatedRides,
  totalCount,
  pageSize,
  hasNext,
  ...
  return (
    <div className='flex items-center justify-between px-2'>
      <div className='text-sm text-muted-foreground'>
        Показано {paginatedRides.length} из {totalCount} поездок

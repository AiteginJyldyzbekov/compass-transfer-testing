...
export function ChangePasswordModal({ isOpen, onClose }: ChangePasswordModalProps) {
  ...
  const onSubmit = async (data: ChangePasswordFormData) => {
    ...
    // success будет обновлен в хуке, поэтому проверяем его в useEffect выше
  };
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              <Input
                ...
                className={`pr-10 hover:shadow-md focus:shadow-md focus-visible:shadow-md transition-shadow ${errors.confirmPassword ? 'border-red-500' : ''}`}
              />
              <button
                type='button'

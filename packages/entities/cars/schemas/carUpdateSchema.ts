...
/**
 * Схема валидации для формы обновления автомобиля
 */
export const carUpdateSchema = z.object({
  ...
  id: z.string().uuid({ message: 'Некорректный идентификатор автомобиля' }),
...
/**
 * Тип данных для API запроса
 */
export type CarUpdateApiData = z.infer<typeof carUpdateSchema>;
/**
 * Тип данных для UI формы
 */
export type CarUpdateFormData = z.infer<typeof carUpdateSchema>;

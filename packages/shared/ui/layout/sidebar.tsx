    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'w-64 group-data-[collapsible=icon]:w-20'
            : 'w-64 group-data-[collapsible=icon]:w-16',
        )}
        style={{
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'p-2 w-64 group-data-[collapsible=icon]:w-20'
            : 'w-64 group-data-[collapsible=icon]:w-16 group-data-[side=left]:border-r group-data-[side=right]:border-l',
          className,
        )}
        style={{
          width: state === 'collapsed' ? 'var(--sidebar-width-icon)' : 'var(--sidebar-width)',
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'relative flex w-full flex-1 flex-col pr-4 pb-4 h-screen overflow-hidden',
        className,
      )}
      {...props}
    />
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform focus-visible:ring-2 focus:outline-none [&>svg]:size-4 [&>svg]:shrink-0',
        // Increases the hit area of the button on mobile.
        'after:absolute after:-inset-2 md:after:hidden',

...
import { BasicDataSection, TerminalDataSection, SecuritySection } from '@entities/users';
import { TERMINAL_FORM_CHAPTERS } from '@entities/users/model/form-chapters/terminal-chapters';
import type { TerminalCreateFormData } from '@entities/users/schemas/terminalCreateSchema';

interface TerminalFormViewProps {
  form: UseFormReturn<TerminalCreateFormData>;
...
export function TerminalFormView({
  form,
  isSubmitting,
  getChapterStatus,
  getChapterErrors,
      ...
      <div className='flex overflow-hidden h-full'>
        ...
        <div className='w-80 flex-shrink-0 flex flex-col h-full'>
          <FormSidebar
            ...
            chapters={TERMINAL_FORM_CHAPTERS.CREATE}

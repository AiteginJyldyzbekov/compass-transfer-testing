...
import { BasicDataSection, SecuritySection } from '@entities/users';
import { CUSTOMER_FORM_CHAPTERS } from '@entities/users/model/form-chapters/customer-chapters';
import type { CustomerCreateFormData } from '@entities/users/schemas/customerCreateSchema';
      ...
      <div className='flex overflow-hidden h-full'>
        ...
        <div className='w-80 flex-shrink-0 flex flex-col h-full'>
          <FormSidebar
            ...
            chapters={CUSTOMER_FORM_CHAPTERS.CREATE}

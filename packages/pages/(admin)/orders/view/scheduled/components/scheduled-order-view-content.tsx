    ...
    <div className='space-y-6'>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          {order.scheduledTime && (
            <div>
              <div className='text-sm text-muted-foreground'>Запланированное время</div>
          ...
          {order.airFlight && (
            <div>
              <div className='text-sm text-muted-foreground'>Номер рейса прилета</div>
          ...
          {order.flyReis && (
            <div>
              <div className='text-sm text-muted-foreground'>Номер рейса вылета</div>
              <div className='font-medium flex items-center gap-2'>
                <Plane className='h-4 w-4' />
                {order.flyReis}
              </div>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div>
            ...
            <div className='font-medium'>Запланированный</div>
          </div>
          <div>
          ...
          {order.scheduledTime && (
            <div>
              <div className='text-sm text-muted-foreground'>Запланирован на</div>
              <div className='font-medium'>{formatDate(order.scheduledTime)}</div>
            </div>
          )}
          {order.completedAt && (
            <div>

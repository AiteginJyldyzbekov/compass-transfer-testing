        ...
        {generatedImage && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="mt-4 text-sm text-gray-600">
              ...
              <p>Шрифты: 22px заголовок, 14px основной текст</p>
              <p>Логотип: до 80px высоты</p>
              <p>Умеренные отступы: невидимые символы + средняя высота</p>
              <p>Заголовок помещается с отступами по бокам</p>
              <p>Каждая строка отделена умеренным отступом (1.25x)</p>
            </div>
          </div>
        )}
      </div>

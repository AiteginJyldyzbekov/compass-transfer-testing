...
export function DriverMobileHeader() {
  ...
  if (isLoading) {
    return (
      <header className='bg-white shadow-sm border-b mx-2 mt-2 px-3 py-3 ios-header rounded-2xl'>
  ...
  return (
    <header className='bg-[#F9F9F9] mx-2 mt-2 relative overflow-hidden ios-header rounded-[20px]'>
